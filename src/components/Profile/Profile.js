...
const UserProfile = (props) => {
  ...
  let addFormFields = () => {
    setaccounts([
      ...accounts,
      { name: "", accountNumber: "", ifsc: "", id: ++accounts.length },
    ]);
    console.log("s")
  };
            ...
            <Row className="mb-3" key={account.id}>
              ...
              <Col xs="auto">
                ...
                <Form.Group
                  ...
                  as={Col}
                  controlId="formGridRemove"
                >
                  {index ? (
                    <i
                      class="fas fa-trash-alt text-danger btn btn-sm btn-light p-2"
  ...
  return (
    <>
      <SharedCard
        ...
        subtitle="User details include PAN,Email,Mobile etc"
      >
        <Form>
          <Row className="mb-3">
            <Form.Label className="profile-lables">
              Basic Information{" "}
            </Form.Label>
            <Col xs="auto">
